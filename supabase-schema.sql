...
create index if not exists "goal_notes_goal_id_created_at_idx" on "public"."goal_notes" ("goal_id", "created_at");

comment on table "public"."goal_notes" is 'Riktekstnotater som knyttes til et mål og kan inneholde lenker og formatering.';
comment on column "public"."goal_notes"."id" is 'Primærnøkkel for notatet.';
comment on column "public"."goal_notes"."goal_id" is 'Referanse til målet notatet tilhører.';
comment on column "public"."goal_notes"."title" is 'Kort tittel som beskriver innholdet i notatet.';
comment on column "public"."goal_notes"."content_html" is 'Sanert HTML som brukes for visning av notatet.';
comment on column "public"."goal_notes"."content_plain" is 'Ren tekst-versjon for søk og backup.';
comment on column "public"."goal_notes"."created_at" is 'Tidspunkt notatet ble opprettet.';
comment on column "public"."goal_notes"."updated_at" is 'Tidspunkt notatet sist ble oppdatert.';
